...
class PointNetClassifier(keras.Model):
    def __init__(self, batch_size, num_classes, bn=False, activation=tf.nn.relu):
        ...
        print('[debug-PointNetClassifier-init] -----------------------------')
    ...
    def init_network(self):
        print('[debug-PointNetClassifier-init_network] -----------------------------')
    ...
    def forward_pass(self, input, training):
        print('[debug-PointNetClassifier-forward_pass] -----------------------------')
    ...
    def train_step(self, input):
        print('[debug-PointNetClassifier-train_step] -----------------------------')
    ...
    def test_step(self, input):
        print('[debug-PointNetClassifier-test_step] -----------------------------')
    ...
    def call(self, input, training=False):
        print('[debug-PointNetClassifier-call] -----------------------------')
